...
<div class="grid-12 alpha omega equal-height-container views-grid-column">
...
?>
<div class="grid-4 views-grid-item equal-height-element<?php print $alpha_omega . $added_class ?>">
